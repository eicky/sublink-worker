    ...
    window.formData = function () {
        ...
        return {
            ...
            init() {
                ...
                this.skipCertVerify = (localStorage.getItem('skipCertVerify') ?? 'true') === 'true';
            ...
            async submitForm() {
                ...
                try {
                    ...
                    params.append('skip_cert_verify', String(this.skipCertVerify));
            ...
            populateFormFromUrl(url) {
                ...
                this.skipCertVerify = (params.get('skip_cert_verify') ?? 'true') === 'true';
                ...
                if (selectedRules || customRules || this.groupByCountry || this.skipCertVerify || this.enableClashUI ||
